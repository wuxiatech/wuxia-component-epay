...
*/
package cn.wuxia.component.epay;
...
import cn.wuxia.component.epay.chinapay.service.ChinaPayService;
...
public abstract class EpayService {
	...
	public PaymentTrade beforeRefund(EpayRefundBean refundBean) throws EpayException {
		...
		if (StringUtil.isNotBlank(refundBean.getSerialNumber())) {
			List<PaymentTrade> lists = paymentTradeService.findBySerialNoAndStatus(refundBean.getSerialNumber(),
					PaymentTradeStatusEnum.CHENGGONG);
