 ...
 */
package cn.wuxia.component.epay.alipay.dispatcher;
...
import cn.wuxia.component.epay.alipay.constants.AlipayServiceEventConstants;
import cn.wuxia.component.epay.alipay.constants.AlipayServiceNameConstants;
import cn.wuxia.component.epay.alipay.executor.ActionExecutor;
import cn.wuxia.component.epay.alipay.executor.InAlipayAsyncMsgSendExecutor;
import cn.wuxia.component.epay.alipay.executor.InAlipayChatTextExecutor;
import cn.wuxia.component.epay.alipay.executor.InAlipayDIYQRCodeEnterExecutor;
import cn.wuxia.component.epay.alipay.executor.InAlipayDefaultExecutor;
import cn.wuxia.component.epay.alipay.executor.InAlipayEnterExecutor;
import cn.wuxia.component.epay.alipay.executor.InAlipayFollowExecutor;
import cn.wuxia.component.epay.alipay.executor.InAlipayUnFollowExecutor;
import cn.wuxia.component.epay.alipay.executor.InAlipayVerifyExecutor;
...
public class Dispatcher {
	...
	public static ActionExecutor getExecutor(Map<String, String> params) throws MyException {
		...
		try {
			bizContentJson = Dom4jXmlUtil.xml2map(bizContent, false);
	 ...
	 * @throws MyException
	 */
	private static ActionExecutor getEventExecutor(String service, Map bizContentJson) throws MyException {
		// 1. 获取事件类型
	 ...
	 * @throws MyException
	 */
	private static ActionExecutor getMsgNotifyExecutor(String eventType, Map bizContentJson) throws MyException {
